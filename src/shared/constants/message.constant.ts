...
export const MESSAGE_DATA_REFRESH_TOKEN = "Successfully refresh token.";
...
export const MESSAGE_DATA_INVALID_LOGIN_CREDENTIALS = "Invalid login credentials.";
...
export const MESSAGE_DATA_NOT_PERMITTED = "You do not have permission to access this resource.";
export const MESSAGE_DATA_NOT_AUTHORIZED = "Not authorized to perform this action.";
export const MESSAGE_DATA_NO_PERMISSION = "No permission to access this action.";
